...
| `.cursor/skills/test-drift/SKILL.md`        | **Skill** — report-only test drift audit. Finds stale mocks, contract literal drift, mock-only verification, dead API coverage, and incomplete setup for claimed reset / sync behavior.                          | --                      |

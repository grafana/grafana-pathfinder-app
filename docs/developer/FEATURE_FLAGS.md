...
Pathfinder does not capture session replay. Grafana core owns replay independently of this flag; see [Session replay ownership](TELEMETRY.md#session-replay-ownership).

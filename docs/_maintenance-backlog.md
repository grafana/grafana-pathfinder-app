...
- **2026-07-22**: `docs/developer/engines/interactive-engine.md` — Updated modal-watcher, telemetry outcome classification, Monaco insertion, popout action, public export, completion-event, and state-ownership descriptions. Validated against the current interactive engine, global completion store, and related tests.
- **2026-07-22**: `docs/developer/engines/requirements-manager.md` — Updated for modular requirement checks, canonical requirement types, controller-mode tab-local filtering, terminal/Coda requirements, and fixed-delay retry behavior. Validated against the requirements manager, controller/live-tab integration, shared types, and related tests.
...
- `docs/history/package-implementation-record.md` — Completed-epic archive already covered by the `docs/history/` route in `docs/developer/CONTEXT_INDEX.md`; current package work should use the living package authoring and engine references.

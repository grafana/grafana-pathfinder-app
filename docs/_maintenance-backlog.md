...
- **2026-09-09**: `docs/developer/E2E_TESTING.md` — Added the step-driver registry, driver contract, discovery/execution/reporting ownership, and the extension path for supporting a new step kind. Validated against the current E2E runner, CLI reporter, result mapping, and report schema. Supersedes the 2026-02-20 entry.
- **2026-09-09**: `docs/developer/E2E_TESTING_CONTRACT.md` — Revalidated the tracked-root kinds, driver ownership, legacy fallback, unsupported coverage, and unsupported-only outcome against the current product registry and E2E runner. Supersedes the 2026-02-20 entry.

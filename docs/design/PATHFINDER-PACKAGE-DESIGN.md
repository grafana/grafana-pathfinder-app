...
2. **Resolve the repository token** to a location (currently hardcoded for `interactive-tutorials`; future configuration layer maps tokens to locations — see [deferred concerns](#deferred-concerns))

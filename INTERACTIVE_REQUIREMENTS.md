...
Tutorial-specific requirements are declared in the `data-requirements` attribute of interactive elements. Multiple requirements are comma-separated.
...
**Rationale**: Users need a place to start. This provides a special exception to the sequential dependency rule for the first step only.

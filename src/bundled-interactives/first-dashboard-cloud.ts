...
export const firstDashboardCloudHtml = `<html>
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <span id="explore-tutorial"
            ...
            <li class="interactive" 
                ...
                <span class="interactive" data-targetaction='highlight' data-reftarget='button:contains("grafana-testdata-datasource")' data-requirements='exists-reftarget'></span>
                <span class="interactive-comment">

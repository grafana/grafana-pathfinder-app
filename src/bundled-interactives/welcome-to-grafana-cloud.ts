    ...
    <body>
        ...
        <span id="grafana-tour" class="interactive" data-requirements="navmenu-open" data-targetaction="sequence" data-reftarget="span#grafana-tour">
            <ul>
              <li class="interactive" 
                  ...
                  data-reftarget="a[data-testid='data-testid Nav menu item'][href='/a/cloud-home-app']"
        ...
        <span id="setup-datasource" 
            ...
            <ul>
              ...
              <li class="interactive" 
                  data-reftarget="input[data-testid='search-input-input']"
              ...
              <li class="interactive"
                  data-reftarget="button:contains('Add new data source')"

...
export const COMPLETION_RECORDS_TIMEOUT_MS = 2000; // small budget for the optional completion-records enhancement; must never meaningfully delay a recommend request

...
export interface UseStepCheckerReturn {
   ...
   * (i.e., a missing DOM element). The AI-powered "Fix this" variant uses
   * this combined with assistant availability to decide whether to surface
   * itself. Independent of `canFixRequirement`: the AI variant is the
   * last-resort path only when no deterministic handler matched.
   */

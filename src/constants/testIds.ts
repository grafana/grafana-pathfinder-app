...
export const testIds = {
  ...
  blockEditor: {
    ...
    generateGuideButton: 'block-editor-generate-guide-button',
    generateGuideModal: 'block-editor-generate-guide-modal',
    generateGuidePromptInput: 'block-editor-generate-guide-prompt',
    generateGuideSubmit: 'block-editor-generate-guide-submit',
    generateGuideCancel: 'block-editor-generate-guide-cancel',
    generateGuideRetry: 'block-editor-generate-guide-retry',
    regenerateSelectorButton: 'block-editor-regenerate-selector-button',
